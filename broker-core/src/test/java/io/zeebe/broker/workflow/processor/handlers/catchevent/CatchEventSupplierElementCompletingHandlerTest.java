...
public class CatchEventSupplierElementCompletingHandlerTest
    extends ElementHandlerTestCase<ExecutableCatchEventSupplier> {
  private CatchEventSupplierElementCompletingHandler<ExecutableCatchEventSupplier> handler;

  @Override
  @Before
  public void setUp() {
    super.setUp();
    handler = new CatchEventSupplierElementCompletingHandler<>();
  }
